                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="chart" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('get_lectures_for_teacher')}}">جميع المحاضرات</a></li>

                            <li> <a href="{{route('zoom.lectures')}}">جميع محاضرات zoom</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="custom-page" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('new_exam')}}">اختبار جديد</a> </li>
                            <li> <a href="{{route('get_all_exams')}}">جميع الاختبارات</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="authentication" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url("/teacher/index/presence_absence")}}">تسجيل حضور وغياب</a> </li>
                            <li> <a href="{{route('get_presence_absence')}}">سجلات الحضور والغياب</a> </li>
                        </ul>
                    </li>
                    ...
                    <!-- menu item maps-->
                    <li>
                        <a href="{{route('get_all_homework')}}"><i class="ti-location-pin"></i><span class="right-nav-text">النشاطات البيتية</span>
