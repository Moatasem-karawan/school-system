...
@section('content')
    ...
    @php
        if (\Illuminate\Support\Facades\App::getLocale()=="ar"){
                $worlds=["add_section"=>"اضافة قسم","name_grade"=>"اسم المرحلة","name_class"=>"اسم الصف","name_section"=>"اسم القسم","add_student"=>"اضافة طالب جديد","name_student"=>"اسم المعلم","email"=>"الايميل","date_student"=>"تاريخ الميلاد","spe"=>"التخصص","father"=>"الاب","password"=>"كلمة السر","phone"=>"رقم الهاتف"];
        }
        else{
                    ...
                    <form method="post"  action="{{route("add-teacher")}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text"  name="phone" autocomplete="f"/>
                            </div>
