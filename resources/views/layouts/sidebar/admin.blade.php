                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route("view.grades")}}">{{$worlds["grades"]}}</a></li>
                    ...
                    <li>
                        ...
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route("view.classrooms")}}">{{$worlds["class_rooms"]}}</a></li>
                    ...
                    <li>
                        ...
                        <ul id="font-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route("sections")}}">عرض جميع الاقسام</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="authentication" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('teacher')}}">اضافة معلم جديد</a> </li>
                            <li> <a href="{{route('show-all-teachers')}}">قائمة المعلمين</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="chart" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('add_material')}}">اضافة مادة جديدة</a> </li>
                            <li> <a href="{{route('get_materials')}}">عرض المواد الدراسية لكل صف</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="table" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('students_parents')}}">اضافة او عرض ولي امر</a> </li>
                            <li> <a href="data-local.html">ابلاغ اولياء الامور</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="custom-page" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('add_students')}}">{{$worlds["add_student"]}}</a> </li>
                            <li> <a href="{{route('push_students')}}">{{$worlds["push_students"]}}</a> </li>
                            <li> <a href="{{route('getall_students')}}">اظهار الطلاب</a> </li>
